            ...
            <div class="col-lg-offset-1 col-lg-10 col-md-offset-1 col-md-10 col-sm-offset-1 col-sm-10 col-xs-12">
                <table id="list_products_tbl" style="border: none;width: 100%;">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;" class="product_list_market_price_btn"><h4><?=$this->lang->line('market_price');?></h4></th>
                        <th style="text-align: center;" class="product_list_our_price_btn"><h4><?=$this->lang->line('our_price');?></h4></th>
                        <th style="text-align: center;" class="product_list_your_save_btn"><h4><?=$this->lang->line('you_save');?></h4></th>
                    </tr>
                    </thead>
                    <tbody id="product-list-tbody">
                        <?php
                            $products = $this->products_m->get_product();
                            echo ($controller->print_products_list($products));
                        ?>
...
<script>
    $(document).ready(function(){
        $('#parent_category').change(function(){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo base_url();?>/products/get_products_list",
