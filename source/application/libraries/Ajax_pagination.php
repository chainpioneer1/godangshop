...
class Ajax_pagination{
    ...
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="products-pagination"><ul>';
    ...
    function getAJAXlink($count, $text) {
        ...
        return '<li><a style="border:1px solid #e2e2e2; "href="javascript:void(0);"' . $this->anchor_class . ' onclick="'.$this->link_func.'('.$pageCount.')">'. $text .'</a></li>';
    }
}